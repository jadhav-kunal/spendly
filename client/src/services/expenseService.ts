...
export const expenseService = {
  ...
  create: (data: ExpenseFormData): Promise<AxiosResponse<ApiResponse<Expense>>> =>
    api.post('/expenses', data),

  update: (id: string, data: Partial<ExpenseFormData>): Promise<AxiosResponse<ApiResponse<Expense>>> =>
